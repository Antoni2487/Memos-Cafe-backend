...
THIRD_PARTY_APPS = [
    ...
    "rest_framework",
    # "rest_framework.authtoken",  # ← eliminado: usamos JWT, no token simple
    "corsheaders",
    "drf_spectacular",
]

# ⚠️  CORRECCIÓN: pagos eliminado (absorbido por caja), mesas e insumos añadidos
LOCAL_APPS = [
    "memos_cafe.users",
...
# ACCESS_TOKEN_LIFETIME: 8h cubre un turno completo de trabajo
SIMPLE_JWT = {
