...
class Orden(models.Model):
    ...
    # Desnormalizado para no recalcular en cada consulta
    ...
    def cerrar(self):
        """El cajero cierra la orden tras cobrarla."""
    ...
    def anular(self):
        """El admin anula una orden (error, duplicado, etc.)."""
        from django.utils import timezone
        if self.estado == self.Estado.CERRADA:
            raise ValueError("No se puede anular una orden ya cerrada.")
