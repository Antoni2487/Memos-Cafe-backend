...
class DashboardView(APIView):
    ...
    def get(self, request):
        ...
        # â”€â”€ ordenes â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ Ventas del dí­a â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        if caja_activa:
            ...
            caja_info = {
                "id": caja_activa.id,
                "cajero": caja_activa.usuario.name or caja_activa.usuario.get_full_name() or caja_activa.usuario.email,                
                "fecha_apertura": caja_activa.fecha_apertura,
                "monto_inicial": caja_activa.monto_inicial,
                "ventas_turno": ventas_turno,
            }

        # â”€â”€ Top 5 productos del dia â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        top_productos = list(
...
class AlertasView(APIView):
    ...
    def get(self, request):
        ...
        for caja in cajas:
            alertas.append({
                "tipo": "caja_apertura",
                "mensaje": f"Caja abierta por el usuario {caja.usuario.name or caja.usuario.get_full_name() or caja.usuario.email}",
            ...
            if caja.fecha_cierre:
                alertas.append({
                    "tipo": "caja_cierre",
                    "mensaje": f"Caja cerrada por el usuario {caja.usuario.name or caja.usuario.get_full_name() or caja.usuario.email}",
